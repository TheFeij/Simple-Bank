...
// request message to create an account
...
var file_rpc_create_account_proto_rawDesc = []byte{
	...
	0x6f, 0x75, 0x6e, 0x74, 0x52, 0x07, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x42, 0x10, 0x5a,
	0x0e, 0x53, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x2d, 0x42, 0x61, 0x6e, 0x6b, 0x2f, 0x70, 0x62, 0x62,
...
var file_rpc_create_account_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_rpc_create_account_proto_goTypes = []interface{}{
	(*CreateAccountResponse)(nil), // 0: pb.CreateAccountResponse
	(*Account)(nil),               // 1: pb.Account
}
var file_rpc_create_account_proto_depIdxs = []int32{
	1, // 0: pb.CreateAccountResponse.account:type_name -> pb.Account
